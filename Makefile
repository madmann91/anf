OBJS=build/anf.o build/io.o build/print.o build/opt.o build/eval.o build/flatten.o build/mem2reg.o build/scope.o build/lca.o build/mpool.o build/htable.o
